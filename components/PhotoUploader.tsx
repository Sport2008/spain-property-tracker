  ...
  async function handleFiles(files: FileList | null) {
    ...
    for (const file of Array.from(files)) {
      ...
      if (file.size > 10 * 1024 * 1024) {
        setError("Maximale bestandsgrootte is 10 MB.");
        continue;
      }
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        disabled={uploading}
        className="w-full flex items-center justify-center gap-2 py-3 border-2 border-dashed border-stone-200 rounded-xl text-sm font-medium text-stone-400 hover:border-terra-400 hover:text-terra-500 transition-colors disabled:opacity-60"
      >
        ...
        {uploading ? "Bezig met uploaden…" : "Foto's toevoegen"}
      </button>
